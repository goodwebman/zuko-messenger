...
/**
 * Единый набор inline-иконок приложения (lucide-стиль: currentColor, stroke 2).
 * Базовый размер 24px — Tailwind-класс (`size-5`) перебивает атрибуты width/height.
 */
...
/** `filled` — залитое сердце для состояния «лайкнуто». */
